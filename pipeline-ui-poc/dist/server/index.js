globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-B0q2HWKp.js","assets/layout-segment-context-Dovi6G2E.js"];
...
function getDraftSecret() {
	return "59df6861-6d4a-4e79-91cc-7771478f4948";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e4928fd0-22a9-40b4-b099-b48c81cb10dc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e4928fd0-22a9-40b4-b099-b48c81cb10dc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e4928fd0-22a9-40b4-b099-b48c81cb10dc",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata() {
	...
	const title = "Sequence Space Explorer · Pipeline Control Center";
	const description = "Run, monitor, and explore the Sequence Space Explorer protein-analysis pipeline from a guided visual workspace.";
	return {
		metadataBase: base,
		title,
		description,
